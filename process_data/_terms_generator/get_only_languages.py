...
LINK = "https://pt.wikipedia.org/wiki/Lista_de_linguagens_de_programa%C3%A7%C3%A3o"
...
def persist_labels(terms: set[str]) -> None:
    for accepted in sorted(terms):
        ...
        db_utils.add_label(accepted.lower(), "LANGUAGE")
...
def main() -> None:
    ...
    save_terms("ACCEPTED_lang.txt", ACCEPTED)
    save_terms("REJECTED_lang.txt", REJECTED)
